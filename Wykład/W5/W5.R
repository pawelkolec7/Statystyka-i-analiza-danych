...
#p value - moment zmiany decycji z nieodrzucenia hipotezy zerowej, do odrzucenia hipoterzy zerowej dla dnaje istotności
#krytczny moement, w którym byśmy mieli zmianę decyzji

A
#alpha = 0.1 > 0.07-pval -> odrzucamy H0
#Decyzja hipoteza zerowa, interpretacja hipoteza jeden
#Jeżeli mi0 nalezy do przedziału ufności, nie podsawt do odrzucenia hipootezy zerowej, działa tylko dla hipotez obustronnych
...
# na poziomie instotności 5% dane nie potwierdzają przypsuszcenia że zrównicowanie czasu naprawy użądzeń jest któtsze niż 25
...
# alpha = 0.05 < 0.13=pval -> brak podstaw do odrzucenia H)
